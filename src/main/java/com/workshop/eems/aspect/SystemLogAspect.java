...
import com.workshop.eems.annotation.SystemControllerLog;
import com.workshop.eems.annotation.SystemServiceLog;
...
public class SystemLogAspect {
    ...
    //Service层切点
    @Pointcut("@annotation(com.workshop.eems.annotation.SystemServiceLog)")
    public void serviceAspect() {
    }

    //Controller层切点
    @Pointcut("@annotation(com.workshop.eems.annotation.SystemControllerLog)")
